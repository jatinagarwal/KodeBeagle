...
object Dependencies {
  ...
  val apiminer =  ("com.github.jatinagarwal" % "apiminer" % "v0.1.5").excludeAll(ExclusionRule(organization = "org.eclipse.core"),
    ExclusionRule(organization = "org.eclipse.osgi"), ExclusionRule(organization = "org.eclipse.birt.runtime"),
    ExclusionRule(organization = "org.eclipse.jdt"), ExclusionRule(organization = "org.slf4j"),
    ExclusionRule(organization = "org.eclipse.equinox"), ExclusionRule(organization = "com.google.guava"),
    ExclusionRule(organization = "org.apache.commons")).exclude("junit", "junit")
